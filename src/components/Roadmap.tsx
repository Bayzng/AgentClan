  ...
  const milestones = [
    {
      ...
      description: "Initial release with core agent functionality and basic integrations.",
    ...
    },
    {
      ...
      description: "Added 15+ new integrations and enhanced AI capabilities.",
    ...
    },
    {
      ...
      description: "Real-time performance monitoring and insights dashboard.",
        ...
        <div className="text-center mb-16">
          ...
          <RevealAnimation delay={0.1}>
            <p className="max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-300">
              The journey ahead for Agent Clan and how we're building the future of AI-powered workflows
            </p>
          </RevealAnimation>
        </div>
