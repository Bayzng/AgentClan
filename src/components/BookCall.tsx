              ...
              <div>
                <RevealAnimation delay={0.2}>
                  <h3 className="text-3xl md:text-4xl font-display font-bold text-gray-900 dark:text-white mb-4 mask-text">
                    Let's discuss how our AI agents can transform your workflow
                  </h3>
                </RevealAnimation>
                
                <RevealAnimation delay={0.3}>
                  <p className="text-lg text-gray-600 dark:text-gray-300">
                    Schedule a personalized call with our team to explore how Agent Clan can be tailored to your specific business needs and challenges.
                  </p>
                </RevealAnimation>
              </div>
