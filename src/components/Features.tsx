...
const Features = () => {
  ...
  return (
    ...
    >
      {/* <DotPattern
        className={cn(
          "[mask-image:radial-gradient(400px_circle_at_center_30%,black,transparent)]"
        )}
      /> */}
      {/* Decorative elements */}
      {/* <div className="absolute top-0 inset-x-0 h-40 bg-gradient-to-b from-brand-50/80 to-transparent dark:from-brand-950/30"></div>
      <div className="absolute -left-32 top-1/3 w-64 h-64 rounded-full bg-purple-100/50 dark:bg-purple-900/20 blur-3xl"></div>
      <div className="absolute -right-32 bottom-1/3 w-64 h-64 rounded-full bg-blue-100/50 dark:bg-blue-900/20 blur-3xl"></div> */}
        ...
        <div className="text-center flex flex-col justify-center items-center mb-16">
          ...
          <RevealAnimation delay={0.2}>
            <p className="max-w-2xl mx-auto text-xl text-gray-600 dark:text-gray-300">
              Our comprehensive suite of features is designed to enhance
        ...
        <div className="mt-24 relative">
          <RevealAnimation>
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300">
                See how Agent Clan integrates with your existing tools to create
                a unified workspace.
              </p>
            </div>
          </RevealAnimation>
          ...
          <RevealAnimation delay={0.2}>
            <div className="relative mx-auto overflow-hidden rounded-2xl backdrop-blur-md p-5 border-[1px] border-slate/20 mask-video-b">
              ...
              <div className="rounded-xl overflow-hidden shadow-2xl dark:shadow-brand-500/5 ">
                <img
